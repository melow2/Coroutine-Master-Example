package com.john.coroutinemaster.base

import android.os.Parcelable
import androidx.appcompat.app.AppCompatActivity
import com.john.coroutinemaster.usecases.channels.usecase1.ChannelUseCase1Activity
import com.john.coroutinemaster.usecases.coroutines.usecase1.PerformSingleNetworkRequestActivity
import com.john.coroutinemaster.usecases.coroutines.usecase10.CalculationInBackgroundActivity
import com.john.coroutinemaster.usecases.coroutines.usecase11.CooperativeCancellationActivity
import com.john.coroutinemaster.usecases.coroutines.usecase12.CalculationInSeveralCoroutinesActivity
import com.john.coroutinemaster.usecases.coroutines.usecase13.ExceptionHandlingActivity
import com.john.coroutinemaster.usecases.coroutines.usecase14.ContinueCoroutineWhenUserLeavesScreenActivity
import com.john.coroutinemaster.usecases.coroutines.usecase15.WorkManagerActivity
import com.john.coroutinemaster.usecases.coroutines.usecase16.PerformanceAnalysisActivity
import com.john.coroutinemaster.usecases.coroutines.usecase17.PerformCalculationOnMainThreadActivity
import com.john.coroutinemaster.usecases.coroutines.usecase2.Perform2SequentialNetworkRequestsActivity
import com.john.coroutinemaster.usecases.coroutines.usecase2.callbacks.SequentialNetworkRequestsCallbacksActivity
import com.john.coroutinemaster.usecases.coroutines.usecase2.rx.SequentialNetworkRequestsRxActivity
import com.john.coroutinemaster.usecases.coroutines.usecase3.PerformNetworkRequestsConcurrentlyActivity
import com.john.coroutinemaster.usecases.coroutines.usecase4.VariableAmountOfNetworkRequestsActivity
import com.john.coroutinemaster.usecases.coroutines.usecase5.NetworkRequestWithTimeoutActivity
import com.john.coroutinemaster.usecases.coroutines.usecase6.RetryNetworkRequestActivity
import com.john.coroutinemaster.usecases.coroutines.usecase7.TimeoutAndRetryActivity
import com.john.coroutinemaster.usecases.coroutines.usecase7.callbacks.TimeoutAndRetryCallbackActivity
import com.john.coroutinemaster.usecases.coroutines.usecase7.rx.TimeoutAndRetryRxActivity
import com.john.coroutinemaster.usecases.coroutines.usecase8.RoomAndCoroutinesActivity
import com.john.coroutinemaster.usecases.coroutines.usecase9.DebuggingCoroutinesActivity
import com.john.coroutinemaster.usecases.flow.usecase1.FlowUseCase1Activity
